...
class simple_ctrl_voice_led(simple_ctrl_control):
    '''
    Voice LED Control
    '''
    ...
    def _led_response_check(self, cmd, data):
        ...
        if data[1] != simple_ctrl_voice_led.LED_RESULT_OK:
    ...
    def set_color(self, color):
        ...
        Set the LED Color
        '''
        cmd = simple_ctrl_voice_led.LED_CMD_SET_COLOR.to_bytes(1, 'little')
        _r, _g, _b = color
    ...
    def get_color(self):
        ...
        Get the LED Color
        '''
        cmd = simple_ctrl_voice_led.LED_CMD_GET_COLOR.to_bytes(1, 'little')
